...
class fanart:
  ...
  # Instantiation
  def __init__(self):
	self.channelPath = os.path.join(os.getcwd(), self.FANART_PATH, self.CHANNEL_PATH)
	self.showPath = os.path.join(os.getcwd(), self.FANART_PATH, self.SHOW_PATH)
	self.genrePath = os.path.join(os.getcwd(), self.FANART_PATH, self.GENRE_PATH)
