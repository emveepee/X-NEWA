...
MOVEMENT_SCROLL_UP = ( ACTION_LEFT_TRIGGER, PAD_LEFT_ANALOG_TRIGGER, ACTION_PAGE_UP, KEYBOARD_PG_UP, PAD_LEFT_TRIGGER, ACTION_GESTURE_SWIPE_UP_TEN )
MOVEMENT_SCROLL_DOWN = ( ACTION_RIGHT_TRIGGER, PAD_RIGHT_ANALOG_TRIGGER, ACTION_PAGE_DOWN, KEYBOARD_PG_DOWN, PAD_RIGHT_TRIGGER, ACTION_GESTURE_SWIPE_DOWN_TEN)
...
MOVEMENT_UP = ( ACTION_MOVE_UP,  ACTION_WHEEL_UP, PAD_LEFT_STICK_UP, PAD_RIGHT_STICK_UP, PAD_DPAD_UP, KEYBOARD_UP, REMOTE_UP,ACTION_GESTURE_SWIPE_UP)
MOVEMENT_DOWN = ( ACTION_MOVE_DOWN, ACTION_WHEEL_DOWN, PAD_LEFT_STICK_DOWN,PAD_RIGHT_STICK_DOWN, PAD_DPAD_DOWN, KEYBOARD_DOWN, REMOTE_DOWN, ACTION_GESTURE_SWIPE_DOWN)
MOVEMENT_LEFT = ( ACTION_MOVE_LEFT, PAD_LEFT_STICK_LEFT, PAD_RIGHT_STICK_LEFT,PAD_DPAD_LEFT, KEYBOARD_LEFT, REMOTE_LEFT, ACTION_RIGHT_STICK_LEFT,ACTION_GESTURE_SWIPE_LEFT)
MOVEMENT_RIGHT = (  ACTION_MOVE_RIGHT, PAD_LEFT_STICK_RIGHT, PAD_RIGHT_STICK_RIGHT, PAD_DPAD_RIGHT, KEYBOARD_RIGHT, REMOTE_RIGHT, ACTION_RIGHT_STICK_RIGHT, ACTION_GESTURE_SWIPE_RIGHT )
